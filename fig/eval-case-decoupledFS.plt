...
set output "eval-case-decoupledFS.eps"
...
set ylabel "Latency (Kcycles)" font ",36"
...
unset xtics
set label "Write" center font ",40" at 0, -200
set label "Read" center font ",40" at 1, -200

plot "eval-case-decoupledFS.txt" using 2:xticlabels(1) title columnheader(2) lc rgb "#F3759E"   fs patter 1,\
